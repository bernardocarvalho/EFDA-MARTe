...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:../../GAMs/MinimalGAM/${TARGET}/
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:../../GAMs/RelayTestGAM/${TARGET}/
#LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$CODE_DIRECTORY/GAMs/RelayTestGAM/${TARGET}/
