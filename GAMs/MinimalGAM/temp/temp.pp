# 0 "MinimalGAMClassInfo.h"
# 1 "/home/michele/Projects/EFDA-MARTe/GAMs/MinimalGAM//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MinimalGAMClassInfo.h"
...
# 5 "MinimalGAMClassInfo.h" 2
# 1 "MinimalGAMInputStructure.h" 1





struct MinimalGAMInputStructure {
...
# 6 "MinimalGAMClassInfo.h" 2
# 1 "MinimalGAMOutputStructure.h" 1
...
# 7 "MinimalGAMClassInfo.h" 2

struct MinimalGAMClassInfo {
    MinimalGAMInputStructure input;
    MinimalGAMOutputStructure output;
};
